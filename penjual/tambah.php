		...
		<form action="" method="post" enctype="multipart/form-data">
			...
			<table>
				<tr>
					<td>Kategori</td>
					<td>:</td>
					<td><input type="text" name="kategori" id="kategori" size="50"></td>
				</tr>
				<tr>
					<td>Judul</td>
					<td>:</td>
					<td><input type="text" name="judul" id="judul" size="50"></td>
				</tr>
				<tr>
					<td>Pengarang</td>
					<td>:</td>
					<td><input type="text" name="pengarang" id="pengarang" size="50"></td>
				</tr>
				<tr>
					<td>Penerbit</td>
					<td>:</td>
					<td><input type="text" name="penerbit" id="penerbit" size="50"></td>
				</tr>
				<tr>
					<td>Tahun Terbit</td>
					<td>:</td>
					<td><input type="text" name="tahun_terbit" id="tahun_terbit" size="50"></td>
				</tr>
				<tr>
					<td>Harga</td>
					<td>:</td>
				...
				<tr>
					<td colspan="3"><br><input type="submit" name="submit" value="Tambah"></td>
				</tr>
			</table>
		</form>
	</div>
